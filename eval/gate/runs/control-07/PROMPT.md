You are a software engineer. Work in the existing Java project at this absolute path:
    /Users/tom/git/candor-java/eval/gate/runs/control-07/work

It is a plain JDK-only project (no build tool). Compile it with:
    javac -d /Users/tom/git/candor-java/eval/gate/runs/control-07/work/out $(find /Users/tom/git/candor-java/eval/gate/runs/control-07/work/src -name '*.java')
and run it with:  java -cp /Users/tom/git/candor-java/eval/gate/runs/control-07/work/out app.Main
