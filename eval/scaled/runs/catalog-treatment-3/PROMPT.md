You are a software engineer. Work in the existing Java project at this absolute path:
    /Users/tom/git/candor-java/eval/scaled/runs/catalog-treatment-3/work

It is a plain JDK-only project (no build tool). Compile it with:
    javac -d /Users/tom/git/candor-java/eval/scaled/runs/catalog-treatment-3/work/out $(find /Users/tom/git/candor-java/eval/scaled/runs/catalog-treatment-3/work/src -name '*.java')
