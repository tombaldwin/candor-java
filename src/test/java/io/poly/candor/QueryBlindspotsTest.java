...
class QueryBlindspotsTest {
    ...
    @Test void rankedSourcesAndTotal() {
        ...
        String out = capture(() -> Query.blindspots(List.of(src, caller, clean), true, false, null, Query.ReportRef.NONE));
    ...
    @Test void statsReasonClassDistribution() {
        ...
        String out = capture(() -> Query.blindspots(List.of(refl, nat, caller), true, true, null, Query.ReportRef.NONE));
        JsonObject o = JsonParser.parseString(out).getAsJsonObject();
    ...
    @Test void classFilterDrillsDownToOneReasonClass() {
        ...
        String out = capture(() -> Query.blindspots(List.of(refl, nat), true, false,
                Query.parseClassFilter("native"), Query.ReportRef.NONE));
        ...
        String stats = capture(() -> Query.blindspots(List.of(refl, nat), true, true,
                Query.parseClassFilter("reflect"), Query.ReportRef.NONE));
