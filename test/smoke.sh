...
want "envelope declares the spec contract 0.17" "$rep" '"spec": "0.17"'
...
want    "--version prints the release + spec"      "$vv" '(spec 0.17)'
...
want    "README pins the spec floor (spec 0.17)"                  "$README_TXT" "spec 0.17"
...
want    "AGENTS pins the spec floor (spec 0.17)"                  "$AGENTS_TXT" "spec 0.17"
