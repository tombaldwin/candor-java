...
want "envelope declares the spec contract 0.11" "$rep" '"spec": "0.11"'
...
want "--help states the spec contract"             "$hp" 'candor-spec 0.11'
...
want    "--version prints the release + spec"      "$vv" '(spec 0.11)'
...
want    "README pins the spec floor (spec 0.11)"                  "$README_TXT" "spec 0.11"
...
want    "AGENTS pins the spec floor (spec 0.11)"                  "$AGENTS_TXT" "spec 0.11"
