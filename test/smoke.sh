...
want "envelope declares the spec contract 0.12" "$rep" '"spec": "0.12"'
...
want "--help states the spec contract"             "$hp" 'candor-spec 0.12'
...
want    "--version prints the release + spec"      "$vv" '(spec 0.12)'
...
want    "README pins the spec floor (spec 0.12)"                  "$README_TXT" "spec 0.12"
...
want    "AGENTS pins the spec floor (spec 0.12)"                  "$AGENTS_TXT" "spec 0.12"
