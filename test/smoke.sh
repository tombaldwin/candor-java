...
want "envelope declares the spec contract 0.22" "$rep" '"spec": "0.22"'
...
want    "--version prints the release + spec"      "$vv" '(spec 0.22)'
...
want    "README pins the spec floor (spec 0.22)"                  "$README_TXT" "spec 0.22"
...
want    "AGENTS pins the spec floor (spec 0.22)"                  "$AGENTS_TXT" "spec 0.22"
