...
want "envelope declares the spec contract 0.20" "$rep" '"spec": "0.21"'
...
want    "--version prints the release + spec"      "$vv" '(spec 0.21)'
...
want    "README pins the spec floor (spec 0.21)"                  "$README_TXT" "spec 0.21"
...
want    "AGENTS pins the spec floor (spec 0.21)"                  "$AGENTS_TXT" "spec 0.21"
