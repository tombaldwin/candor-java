...
want "envelope declares the spec contract 0.18" "$rep" '"spec": "0.18"'
...
want    "--version prints the release + spec"      "$vv" '(spec 0.18)'
...
want    "README pins the spec floor (spec 0.18)"                  "$README_TXT" "spec 0.18"
...
want    "AGENTS pins the spec floor (spec 0.18)"                  "$AGENTS_TXT" "spec 0.18"
